...
class TitleBarButton(QAbstractButton):
    ...
    def getNormalColor(self):
        """ getTranslation the icon color of the button in normal state """
        return self._normalColor

    def getHoverColor(self):
        """ getTranslation the icon color of the button in hover state """
        return self._hoverColor

    def getPressedColor(self):
        """ getTranslation the icon color of the button in pressed state """
        return self._pressedColor

    def getNormalBackgroundColor(self):
        """ getTranslation the background color of the button in normal state """
        return self._normalBgColor

    def getHoverBackgroundColor(self):
        """ getTranslation the background color of the button in hover state """
        return self._hoverBgColor

    def getPressedBackgroundColor(self):
        """ getTranslation the background color of the button in pressed state """
    ...
    def _getColors(self):
        """ getTranslation the icon color and background color """
    ...
    #normalBackgroundColor = pyqtProperty(QColor, getNormalBackgroundColor, setNormalBackgroundColor)
    ...
    #pressedBackgroundColor = pyqtProperty(QColor, getPressedBackgroundColor, setPressedBackgroundColor)
