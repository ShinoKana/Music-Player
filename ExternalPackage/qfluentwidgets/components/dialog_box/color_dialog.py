# coding:utf-8
from PySide2.QtCore import Qt, Signal, QPoint, QRegExp
from PySide2.QtGui import (QIcon, QBrush, QColor, QMouseEvent, QPixmap,
...
class ColorDialog(MaskDialogBase):
    ...
    def __init__(self, color: QColor, title: str, parent=None):
        from Core import AutoTranslateWord
        super().__init__(parent)
        ...
        self.yesButton = QPushButton(AutoTranslateWord('ok'), self.buttonGroup)
        self.cancelButton = QPushButton(AutoTranslateWord('cancel'), self.buttonGroup)
        ...
        self.newColText  = QLabel(AutoTranslateWord('new color'), self.scrollWidget)
        self.oldColText  = QLabel(AutoTranslateWord('old color'), self.scrollWidget)
    ...
    def __initWidget(self):
        ...
        self.widget.setMaximumSize(610, 650)
        self.widget.resize(610, 650)
        self.scrollWidget.resize(550, self.huePanel.height() + self.brightSlider.height() +90)
    ...
    def __initLayout(self):
        ...
        self.oldColorCard.move(360, self.newColorCard.geometry().bottom()+10)
        self.brightSlider.move(0, 405)
        self.newColText.move(self.newColorCard.geometry().right() + 30, self.newColorCard.geometry().top() + self.newColorCard.height()/2)
        self.oldColText.move(self.oldColorCard.geometry().right() + 30, self.oldColorCard.geometry().top() + self.oldColorCard.height()/2)
