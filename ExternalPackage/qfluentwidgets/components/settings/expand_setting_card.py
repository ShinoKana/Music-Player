# coding:utf-8
from PySide2.QtCore import (Qt, QPropertyAnimation, Property, QEasingCurve,
                            QParallelAnimationGroup, QRect, QSize, QPoint)
from PySide2.QtGui import QPixmap, QPainter
from PySide2.QtWidgets import QFrame, QWidget, QToolButton, QApplication
...
class ExpandSettingCard(QFrame):
    ...
    def _adjustViewSize(self):
        ...
        spacing = (len(self.viewLayout.widgets) - 1) * self.viewLayout.spacing()
