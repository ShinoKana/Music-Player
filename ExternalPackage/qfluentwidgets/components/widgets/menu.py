# coding:utf-8
from ExternalPackage.qframelesswindow import WindowEffect
from PySide2.QtCore import QEasingCurve, QEvent, QPoint, QRect, Qt, QPropertyAnimation
from PySide2.QtWidgets import QAction, QApplication, QMenu, QWidget
...
class DWMMenu(QMenu):
    ...
    def getPopupPos(self, widget: QWidget):
        """ getTranslation suitable popup position
