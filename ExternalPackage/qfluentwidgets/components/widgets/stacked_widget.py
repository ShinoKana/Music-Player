...
#from PyQt5.QtCore import (QAbstractAnimation, QEasingCurve,QParallelAnimationGroup, QPoint, QPropertyAnimation,pyqtSignal)
#from PyQt5.QtWidgets import QGraphicsOpacityEffect, QStackedWidget, QWidget
from PySide2.QtCore import (QAbstractAnimation, QEasingCurve,QParallelAnimationGroup, QPoint, QPropertyAnimation,Signal)
...
class PopUpAniStackedWidget(QStackedWidget):
    ...
    def setCurrentIndex(self, index: int, isNeedPopOut: bool = False, isShowNextWidgetDirectly: bool = True,
        ...
        # getTranslation the index of widget to be displayed
        self.__nextIndex = index
