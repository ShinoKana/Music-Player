...
from ExternalPackage.qfluentwidgets import qconfig
...
class Toast(QWidget):
    def __init__(self, parent, text="", icon=None, closeButton=True):
        ...
        self.layout.addWidget(self.conwdt, alignment=Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.close_btn.setStyleDict({
                ...
                "background-color" : (0,0,0,0) if qconfig.theme=='dark' else (255, 255, 255, 180),
                "font-size" : 14,
                "color" : (255, 255, 255, 130) if qconfig.theme=='dark' else (255, 255, 255, 255),
                "border-radius" : 100,
            })
        self.close_btn.setStyleDict({
