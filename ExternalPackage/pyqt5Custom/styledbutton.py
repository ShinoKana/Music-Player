...
from PySide2.QtWidgets import QWidget, QHBoxLayout, QLabel, QAbstractButton, QGraphicsDropShadowEffect, QGraphicsOpacityEffect
...
class StyledButton(QAbstractButton):
    def __init__(self, text="", icon=None, parent=None):
        ...
        self.thisStyleDict = {
            "default" : {
                ...
                "background-color": (255, 255, 255) if self.appManager.config.isLightTheme() else (50, 50, 50),
    ...
    def setStyleDict(self, styledict, state=None):
        if state is None:
            for k in styledict:
                self.thisStyleDict["default"][k] = styledict[k]
                self.thisStyleDict["hover"][k] = styledict[k]
                self.thisStyleDict["press"][k] = styledict[k]
                self.thisStyleDict["check-hover"][k] = styledict[k]
        else:
            for k in styledict:
                self.thisStyleDict[state][k] = styledict[k]

    def copyStyleDict(self, widget):
        for state in widget.thisStyleDict:
            self.setStyleDict(widget.thisStyleDict[state], state)
    ...
    def paintEvent(self, event):
        pt = QPainter()
        pt.begin(self)
        pt.setRenderHint(QPainter.Antialiasing, on=self.thisStyleDict["default"]["render-aa"])

        dsr1 = self.thisStyleDict["default"]["drop-shadow-radius"]
        dsr2 = self.thisStyleDict["hover"]["drop-shadow-radius"]
        dsr3 = self.thisStyleDict["press"]["drop-shadow-radius"]
        dso1 = self.thisStyleDict["default"]["drop-shadow-offset"]
        dso2 = self.thisStyleDict["hover"]["drop-shadow-offset"]
        dso3 = self.thisStyleDict["press"]["drop-shadow-offset"]
        dsc1 = self.thisStyleDict["default"]["drop-shadow-alpha"]
        dsc2 = self.thisStyleDict["hover"]["drop-shadow-alpha"]
        dsc3 = self.thisStyleDict["press"]["drop-shadow-alpha"]
        ...
        if self.isChecked():
            fc1 = QColor(*self.thisStyleDict["press"]["color"])
            fc2 = QColor(*self.thisStyleDict["check-hover"]["color"])
            fc = self.anim_hover.lerp(fc1, fc2)
        else:
            fc1 = QColor(*self.thisStyleDict["default"]["color"])
            fc2 = QColor(*self.thisStyleDict["hover"]["color"])
            fc3 = QColor(*self.thisStyleDict["press"]["color"])
        ...
        fs1 = self.thisStyleDict["default"]["font-size"]
        fs2 = self.thisStyleDict["hover"]["font-size"]
        fs3 = self.thisStyleDict["press"]["font-size"]
        #print(fs1, fs2, fs3)
        ...
        fnt.setPixelSize(fs)
        if not self.thisStyleDict["default"]["font-subpixel-aa"]: fnt.setStyleStrategy(QFont.NoSubpixelAntialias)
        if self.thisStyleDict["default"]["font-family"]: fnt.setFamily(self.thisStyleDict["default"]["font-family"])
        self.textLbl.setFont(fnt)

        pc1 = QColor(*self.thisStyleDict["default"]["border-color"])
        pc2 = QColor(*self.thisStyleDict["hover"]["border-color"])
        pc3 = QColor(*self.thisStyleDict["press"]["border-color"])
        ...
        pw1 = self.thisStyleDict["default"]["border-width"]
        pw2 = self.thisStyleDict["hover"]["border-width"]
        pw3 = self.thisStyleDict["press"]["border-width"]
        ...
        if self.isChecked():
            b1 = QColor(*self.thisStyleDict["press"]["background-color"])
            b1 = QColor('white')
            b2 = QColor(*self.thisStyleDict["check-hover"]["background-color"])
            b = self.anim_hover.lerp(b1, b2)
        else:
            b1 = QColor(*self.thisStyleDict["default"]["background-color"])
            b2 = QColor(*self.thisStyleDict["hover"]["background-color"])
            b3 = QColor(*self.thisStyleDict["press"]["background-color"])
            b4 = QColor(*self.thisStyleDict["check-hover"]["background-color"])
        ...
        r1 = self.thisStyleDict["default"]["border-radius"]
        r2 = self.thisStyleDict["hover"]["border-radius"]
        r3 = self.thisStyleDict["press"]["border-radius"]
        ...
        crn = self.thisStyleDict["default"]["radius-corners"]

        if all(crn) and self.thisStyleDict["default"]["render-fast"]:
