    ...
    def parentMouseMoveEvent(self, event):
        if self.cur is not None and self._resizable:
            ...
            if self.cur in ("east", "southeast", "south"):
                ...
                # self.parentLayout().setFixedSize(self.parentLayout().width()-x,
                #                            self._orh + y)
                #
                # self.parentLayout().move(self._orx - x,
                #                    self.parentLayout().y())
                ...
                self.parent().setGeometry(self._orx - x,
                                          ...
                                          self.parent().width()-x,
                                          self._orh + y)
                #self.parentLayout().update()

                self._orx += x
                self._orh += y
                #self._ory += y

            #self.parentLayout().setGeometry(self.parentLayout().x(), self.parentLayout().y(), self._orw+x, self.parentLayout().height())
